...
import { convertFile, formatFileSize, downloadFile } from "@/lib/utils";
...
function sizeDiff(before: number, after: number) {
  ...
  return <p style={{ color: color }}>{percentageDiff.toFixed(2)}%</p>;
}
...
function display_button(
  ...
  return (
    <div>
      ...
      >
        Download {formatFileSize(file.sizeAfter)}
      </Button>
